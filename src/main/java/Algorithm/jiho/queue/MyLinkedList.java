...
public class MyLinkedList {
    ...
    public void add(int data) {
        // 1. start == null (LinkedList가 비어있음)
        if (start == null) start = new Node(data);
            // 2. 아니라면, 다음 link가 null인 Node가 나올때까지
        else {
            Node head = start;
            ...
            // while문이 끝났을 때, head.link == null (마지막 노드임)
    ...
    public static void main(String[] args) {
        ...
        System.out.println(linkedList.remove(0));   // 1 (0번째 remove한 값)
